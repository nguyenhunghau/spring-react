...
ssh -i /mnt/ec2-sin.pem ec2-user@54.255.250.93 "cd /home/ec2-user && sudo docker rm -f `docker ps -aq` && sudo docker-compose up --force-recreate --build -d && sudo docker image prune -f"
