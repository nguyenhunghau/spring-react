...
public class ProxyUrlUtils extends URLUtils {
    ...
    private JobEntity createJobEntity(String mainUrl, Element element, Map<String, String> queryMap) throws UrlException {
        ...
        if(dateArray[0].endsWith("m") || dateArray[0].endsWith("h") || dateArray[0].endsWith("d")) {
            dateArray[0] = dateArray[0].substring(0, dateArray[0].length() - 1);
        }
    ...
    private String makeCompanyData(JobEntity entity, Document document, Map<String, String> queryMap) {
    ...
    private JobEntity modifyJobEntity(JobEntity entity, Document document, Map<String, String> queryMap) {
